...
class App extends Container
{
    ...
    public function init($module = '')
    {
        ...
        if (is_file($path . 'init.php')) {
            ...
            // 加载公共文件
            if (is_file($path . 'domain.php')) {
                include_once $path . 'domain.php';
            }
     ...
     */
    public function create($name, $layer, $appendSuffix = false, $common = 'domain')
    {
        $guid = $name . $layer;
     ...
     * @throws ClassNotFoundException
     */
    public function model($name = '', $layer = 'model', $appendSuffix = false, $common = 'domain')
    {
     ...
     * @throws ClassNotFoundException
     */
    public function validate($name = '', $layer = 'validate', $appendSuffix = false, $common = 'domain')
    {
